defmodule Symphony.WatchdogTest do
  ...
  test "watchdog escalation upserts a Linear comment with a mention" do
    ...
    assert body =~ "tried to recover this issue"
    assert body =~ "The practical next step is:"
    refute body =~ "Please inspect this issue"
  end
  ...
  test "watchdog escalation does not use unresolved raw mention text" do
    ...
    assert body =~ "Symphony watchdog tried to recover this issue"
  end
